...
Code and aggregated data to reproduce the figures can be found on the github repo [FAM-Public-Repo](https://github.com/lasy/FAM-Public-Repo).

Specifically, click [here]() for the rendered [Rmd]() (R code) used to generate the Figures.
